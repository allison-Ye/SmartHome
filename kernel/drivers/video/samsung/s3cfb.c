...
static int __devinit s3cfb_probe(struct platform_device *pdev)
{
	...
	{      
               fbdev->lcd->freq=30;
               fbdev->lcd->width=480;
               fbdev->lcd->height=272;
               //fbdev->lcd->p_width=480; //bs android error
	       //fbdev->lcd->p_height=272;
	       fbdev->lcd->timing.h_sw=41;
	       fbdev->lcd->timing.v_sw=10;
	       fbdev->lcd->timing.h_fp=2;
	       fbdev->lcd->timing.h_bp=2;
	       fbdev->lcd->timing.v_fp=2;
	       fbdev->lcd->timing.v_bp=2;
	...
	{  
               fbdev->lcd->freq=30;
               fbdev->lcd->width=800;
               fbdev->lcd->height=480;
               //fbdev->lcd->p_width=800; //bs android error
	       //fbdev->lcd->p_height=480;
	       fbdev->lcd->timing.h_sw=48;
	       fbdev->lcd->timing.v_sw=3;
	       fbdev->lcd->timing.h_fp=40;
	       fbdev->lcd->timing.h_bp=40;
	       fbdev->lcd->timing.v_fp=13;
	       fbdev->lcd->timing.v_bp=29;
	...
	else if(lcdsize == 4)
	{
               fbdev->lcd->freq=30;
               fbdev->lcd->width=800;
               fbdev->lcd->height=600;
               //fbdev->lcd->p_width=800; //bs android error
	       //fbdev->lcd->p_height=600;
	       fbdev->lcd->timing.h_sw=48;
	       fbdev->lcd->timing.v_sw=3;
	       fbdev->lcd->timing.h_fp=40;
	       fbdev->lcd->timing.h_bp=40;
