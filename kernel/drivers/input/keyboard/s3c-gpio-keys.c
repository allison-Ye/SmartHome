...
{	
	...
	{
	    .pin = S5PV210_GPH0(3),//k1
	    .eintcfg = 0X0f<<12,
	    .inputcfg = 0<<12,
	    .eint = IRQ_EINT3,
	},
	{
	    .pin = S5PV210_GPH0(4),//k2
	    .eintcfg = 0X0f<<16,
	    .inputcfg = 0<<16,
	    .eint = IRQ_EINT4,
	},
	...
	{
	    .pin = S5PV210_GPH0(5),//k3
	    .eintcfg = 0X0f<<20,
	    .inputcfg = 0<<20,
	    .eint = IRQ_EINT5,
	},
	{
	    .pin = S5PV210_GPH0(6),//k4
	    .eintcfg = 0X0f<<24,
	    .inputcfg = 0<<24,
	    .eint = IRQ_EINT6,
	},
	{
	    .pin = S5PV210_GPH0(7),//k5
	    .eintcfg = 0X0f<<28,
	    .inputcfg = 0<<28,
	    .eint = IRQ_EINT7,
	},
	...
	{
	    .pin = S5PV210_GPH0(2),//k3
	    .eintcfg = 0X0f<<8,
	    .inputcfg = 0<<8,
	    .eint = IRQ_EINT2,
	},
	{
	    .pin = S5PV210_GPH0(3),//k4
	    .eintcfg = 0X0f<<12,
	    .inputcfg = 0<<12,
	    .eint = IRQ_EINT3,
	},
	{
	    .pin = S5PV210_GPH0(4),//k5
	    .eintcfg = 0X0f<<16,
	    .inputcfg = 0<<16,
	    .eint = IRQ_EINT4,
	},
	...
	{
	    .pin = S5PV210_GPH0(5),//k6
	    .eintcfg = 0X0f<<20,
	    .inputcfg = 0<<20,
	    .eint = IRQ_EINT5,
	},
	{
	    .pin = S5PV210_GPH0(6),//k7
	    .eintcfg = 0X0f<<24,
	    .inputcfg = 0<<24,
	    .eint = IRQ_EINT6,
	},
	{
	    .pin = S5PV210_GPH0(7),//k8
	    .eintcfg = 0X0f<<28,
	    .inputcfg = 0<<28,
	    .eint = IRQ_EINT7,
	},
