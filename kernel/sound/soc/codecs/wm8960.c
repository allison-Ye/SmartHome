...
#endif
	0x0117, 0x0117, 0x001f, 0x011f, 0x0048, 0x0000, 0x0000, 0x0002,
	0x01C0, 0x0040, 0x00ff, 0x01ff, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x007f, 0x0100, 0x0132, 0x0001, 0x01C3, 0x01C3, 0x01C5,
    0x0000, 0x01ee, 0x01e0, 0x0040, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0148, 0x0048, 0x0100, 0x0050, 0x0050, 0x0100, 0x0080, 0x0080,
    0x0000, 0x0000, 0x0040, 0x0000, 0x0000, 0x0000, 0x0000, 0x002c,
    0x0012, 0x0037, 0x004d, 0x00bf, 0x0008, 0x0031, 0x0026, 0x00e9,
};
...
/* begin: add by muyinghua PN: ok210 */
SOC_SINGLE("Left ADC Volume ok210", WM8960_LADC, 0, 255, 0),
SOC_SINGLE("Right ADC Volume ok210", WM8960_RADC, 0, 255, 0),
/* end:  add by muyinghua PN: ok210 */
			   ...
			   enum snd_soc_control_type control)
{
	...
	snd_soc_write(codec, WM8960_LADC, 0x01ff);
	snd_soc_write(codec, WM8960_RADC, 0x01ff);
#endif

	snd_soc_write(codec, WM8960_INBMIX1, 0x2);
	snd_soc_write(codec, WM8960_INBMIX2, 0x2);
	/* end:  add by muyinghua PN: ok210 */
