...
//forlinx.bs
//offeset
#define ELFIN_NAND_BASE (0x0)//#define ELFIN_NAND_BASE			0xB0E00000
#define ELFIN_NAND_ECC_BASE (0x20000)//#define ELFIN_NAND_ECC_BASE		0xB0E20000
...
//offeset
#define S3C_NFECCCONF			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONF_OFFSET)
#define S3C_NFECCCONT			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONT_OFFSET)
#define S3C_NFECCSTAT			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCSTAT_OFFSET)
#define S3C_NFECCSECSTAT		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCSECSTAT_OFFSET)
#define S3C_NFECCPRGECC0		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC0_OFFSET)
#define S3C_NFECCPRGECC1		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC1_OFFSET)
#define S3C_NFECCPRGECC2		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC2_OFFSET)
#define S3C_NFECCPRGECC3		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC3_OFFSET)
#define S3C_NFECCPRGECC4		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC4_OFFSET)
#define S3C_NFECCPRGECC5		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC5_OFFSET)
#define S3C_NFECCPRGECC6		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCPRGECC6_OFFSET)
#define S3C_NFECCERL0			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL0_OFFSET)
#define S3C_NFECCERL1			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL1_OFFSET)
#define S3C_NFECCERL2			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL2_OFFSET)
#define S3C_NFECCERL3			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL3_OFFSET)
#define S3C_NFECCERL4			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL4_OFFSET)
#define S3C_NFECCERL5			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL5_OFFSET)
#define S3C_NFECCERL6			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL6_OFFSET)
#define S3C_NFECCERL7			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERL7_OFFSET)
#define S3C_NFECCERP0			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERP0_OFFSET)
#define S3C_NFECCERP1			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERP1_OFFSET)
#define S3C_NFECCERP2			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERP2_OFFSET)
#define S3C_NFECCERP3			S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCERP3_OFFSET)
#define S3C_NFECCCONECC0		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC0_OFFSET)
#define S3C_NFECCCONECC1		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC1_OFFSET)
#define S3C_NFECCCONECC2		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC2_OFFSET)
#define S3C_NFECCCONECC3		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC3_OFFSET)
#define S3C_NFECCCONECC4		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC4_OFFSET)
#define S3C_NFECCCONECC5		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC5_OFFSET)
#define S3C_NFECCCONECC6		S5P_NFREG(ELFIN_NAND_ECC_BASE+NFECCCONECC6_OFFSET)
//forlinx.bs
